...
# The /beamlens inspector wears the same tokens as the rest of the dashboard:
# Livebook's greys and status hues, with the Goatmire purple in place of its
# structural blue. The fonts are the self-hosted files under priv/static/fonts.
config :beamlens_web,
  theme: [
    default: :light,
    light: %{
